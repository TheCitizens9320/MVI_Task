...
uniswapPair = getUniswapPair()
sushiPair = getSushiswapPair()
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
for i in dataPairsUNI:
	if count_1 in [0,8,10,13]:
		reserversUNI.append(i.functions.getReserves().call()[0]/1000000000000000000)
		reserversUNI.append(i.functions.getReserves().call()[1]/1000000000000000000)
	elif count_1 == 4:
		reserversUNI.append(i.functions.getReserves().call()[1]/1000000000000000000)
		reserversUNI.append(i.functions.getReserves().call()[0]/100000000)
	elif count_1 == 9:
		reserversUNI.append(i.functions.getReserves().call()[1]/1000000000000000000)
		reserversUNI.append(i.functions.getReserves().call()[0]/10000)
	else:
		reserversUNI.append(i.functions.getReserves().call()[1]/1000000000000000000)
		reserversUNI.append(i.functions.getReserves().call()[0]/1000000000000000000)
	count_1 +=1
...
reserversSUSHI = []
dataPairSUSHI = [WETH_ENJ_SU, WETH_MANA_SU, WETH_SAND_SU,WETH_AUDIO_SU,WETH_WAX_SU,WETH_ERN_SU,WETH_NFTX_SU,WETH_AXS_SU,WETH_DG_SU,WETH_WHALE_SU,WETH_TVK_SU,WETH_ILV_SU,WETH_REVV_SU,WETH_RARI_SU,WETH_MVI_SU]#co 5 pair khong ton tai WETH-SAND, WETH-WAX, WETH-ERN, WETH-WHALE, WETH-TVK
count_2 = 0
for i in dataPairSUSHI:
	if i == 0:
		reserversSUSHI.append(0)
		reserversSUSHI.append(0)
	elif count_2 in [0,8,10,13]:
		reserversSUSHI.append(i.functions.getReserves().call()[0]/1000000000000000000)
		reserversSUSHI.append(i.functions.getReserves().call()[1]/1000000000000000000)
	elif count_2 == 4:
		reserversSUSHI.append(i.functions.getReserves().call()[1]/1000000000000000000)
		reserversSUSHI.append(i.functions.getReserves().call()[0]/100000000)
	elif count_2 == 9:
		reserversSUSHI.append(i.functions.getReserves().call()[1]/1000000000000000000)
		reserversSUSHI.append(i.functions.getReserves().call()[0]/10000)
	else:
		reserversSUSHI.append(i.functions.getReserves().call()[1]/1000000000000000000)
		reserversSUSHI.append(i.functions.getReserves().call()[0]/1000000000000000000)
	count_2 +=1
#Xong cac buoc tren ca co duoc danh sach cac tham so cua cac pair, tham so cua cac token con de mint 1 MVI
#mintData chua so luong cac token con de mint ra 1 MVI, bat dau tu index 1
#reservers chua thong tin cac pair
#Khai bao ham tinh benefit
#Khai bao ham tinh toan de chon Uni hay Sushi truyen vao so luong 1 loai token nao do va stt cua pair
...
def calculateMaximumBenefit(left, right):
	...
	print(right)
	print(left)
	return calculateBenefit(right)
print(calculateMaximumBenefit(0, right))
print("time:")
print(time.time()-time1)